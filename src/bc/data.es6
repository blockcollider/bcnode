...
export const BLOCKCHAIN_NAMES = Object.keys(BLOCK_FILE_NAMES)

export const BLOCK_PATHS = BLOCKCHAIN_NAMES.reduce((acc, val) => {
...
export const BLOCKS_MAP = BLOCKCHAIN_NAMES.reduce((acc, val) => {
...
export const BLOCKS_ARRAY = BLOCKCHAIN_NAMES.map((name) => {
  return BLOCKS_MAP[name]
})

export const MINEABLE_BLOCKS = transpose(BLOCKS_ARRAY)

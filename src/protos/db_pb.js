...
proto.bc.DbValue.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.bc.JsType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 2:
...
/**
 * optional JsType type = 1;
 * @return {!proto.bc.JsType}
 */
proto.bc.DbValue.prototype.getType = function() {
  return /** @type {!proto.bc.JsType} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.bc.JsType} value */

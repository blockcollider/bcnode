...
proto.bc.RoverMessage.Resync.toObject = function(includeInstance, msg) {
  var f, obj = {
    missingLatest: jspb.Message.getFieldWithDefault(msg, 1, false),
...
/**
 * optional bool missing_latest = 1;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.bc.RoverMessage.Resync.prototype.getMissingLatest = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.bc.RoverMessage.Resync.prototype.setMissingLatest = function(value) {
  jspb.Message.setField(this, 1, value);
};

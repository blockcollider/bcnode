...
goog.exportSymbol('proto.bc.BlockReply', null, global);
 ...
 * @constructor
 */
proto.bc.BlockReply = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
 ...
 * @return {!Object}
 */
proto.bc.BlockReply.prototype.toObject = function(opt_includeInstance) {
  return proto.bc.BlockReply.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bc.BlockReply} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bc.BlockReply.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bc.BlockReply}
 */
proto.bc.BlockReply.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bc.BlockReply;
  return proto.bc.BlockReply.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bc.BlockReply} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bc.BlockReply}
 */
proto.bc.BlockReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bc.BlockReply.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bc.BlockReply.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bc.BlockReply} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bc.BlockReply.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};

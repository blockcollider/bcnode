...
exports.opcodes = {
   ...
   * Signature == OP_PUSHDATA2 <blockHash> OP_PUSHDATA2 <sig> OP_PUSHDATA2 <pubKey> 
   *
   */ 
  OP_CHECKFIBER: 0x25e,  
   ...
   * Output == OP_DUP <chain> OP_VERIFYEQUAL OP_CHECKSIGCHAIN 
   * Signature == OP_PUSHDATA2 <sig> OP_PUSHDATA2 <chain> 
   *
   */ 
  OP_CHECKSIGCHAIN: 0x25f,
   ...
   * Output == OP_HASHSCH
   * Signature == <data> <rParam> 
   *
   */ 
  OP_HASHSCHNORR: 0x260,
   ...
   *
   * 
   * Agree: <sig> OP_DEBIT OP_VERIFYDEBIT
   * Claim: <sig> <publicKey> <expire> <amount> OP_CREDIT OP_VERIFYCREDIT 
   *
   */ 
  OP_DEBITEXP: 0x262

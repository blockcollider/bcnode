...
exports.opcodes = {
   ...
   *
   * Ex. Inputs the stack to the tx stack returns the output of the checked stack. 
   *
   */ 
  OP_PUSHSTACK: 0x104,
   ...
   *
   * Ex. Withdraws value from transaction to stack 
   *
   */ 
  OP_DEBITSTACK: 0x105,
   ...
   * Arguments: <stackId> <amount> 
   *
   * Ex. Confirms value is credited given stack
   *
   */ 
  OP_CREDITSTACK: 0x106,
   ...
   * Arguments: <amount> 
   *
   * Ex. Amount sent to unspent output TX 
   *
   */ 
  OP_SEND: 0x108

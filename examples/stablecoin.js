...
ethOutput.script.fromArray([
  "OVER",
  "SWAP",
  "PUSHDATA " + Convert.eth().id,
  "VERFIYSIGCLAIM",
  "DUP",
  "PUSHDATA " + ethToken.address(),
  "PUSHDATA " + Convert.eth().id,
  "CHECKSIGCHAINBENEFACTOR",
  "PUSHDATA " + Convert.eth().id,
  "PUSHDATA 5",
  "PUSHDATA 100",
  "VERIFYBLOCKCHAINSEQUENCEGTE",
  "PUSHDATA 10",
  "BALANCEUNITS",
  "PUSHDATA " + Convert.nrg(10, "nrg").toBosons(),
  "BALANCE"
...
neoOutput.script.fromArray([
  "OVER",
  "SWAP",
  "PUSHDATA " + Convert.neo().id,
  "VERFIYSIGCLAIM",
  "DUP",
  "PUSHDATA " + neoToken.address(),
  "PUSHDATA " + Convert.neo().id,
  "CHECKSIGCHAINBENEFACTOR",
  "PUSHDATA " + Convert.neo().id,
  "PUSHDATA 5", "PUSHDATA 100",
  "VERIFYBLOCKCHAINSEQUENCEGTE",
  "PUSHDATA 10",
  "BALANCEUNITS",
  "PUSHDATA " + Convert.nrg(10, "nrg").toBosons(),
